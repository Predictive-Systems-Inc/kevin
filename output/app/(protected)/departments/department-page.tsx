...
export default async function DepartmentSearchPage({ searchParams }: IndexPageProps) {
  const url = new URL('http://localhost:3000/api/department')
  ...
  const departmentsPromise: Promise<{
